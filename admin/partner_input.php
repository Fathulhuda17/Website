...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "partner_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update partner set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into partner(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Partner</h1>
<div class="mb-3 row">
    <a href="partner.php">
        << Kembali ke halaman admin Partner</a>
</div>
<?php
if ($error) {
?>
